        ...
        <tbody>
            <?php foreach ($consulta->fetchAll(PDO::FETCH_OBJ) as $dados) : ?>
                ...
                <tr>
                    ...
                    <td><?= $dados->cidade ?></td>
                    <td>
                        <a href="cadastro/cliente/<?= $dados->id ?>" title="Editar Cliente <?= $dados->id ?>" 
                        class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a>
                        <button class="btn btn-danger btn-sm" title="Deletar Cliente <?= $dados->id ?>"
                         onclick="excluir(<?= $dados->id ?>)"><i class="fas fa-trash"></i></button>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
